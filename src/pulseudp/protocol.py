...
class Descriptor:
    ...
    def plot_fields(self) -> List[Field]:
        """Fields to plot: every field.

        The X axis is a synthetic per-sample counter generated by the client
        (see :class:`~pulseudp.model.RingBuffer`), not a descriptor field.
        """
